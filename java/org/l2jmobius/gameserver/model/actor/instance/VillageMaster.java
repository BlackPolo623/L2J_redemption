			...
			switch (cmdChoice)
			{
				...
				case 3: // Change/Cancel Subclass - Initial
				{
					...
					if (player.getTotalSubClasses() >= 1)
					{
						...
						{
							final SubClassHolder subClass = subList.next();
							content3.append("副职业" + classIndex++ + "<br><a action=\"bypass -h npc_%objectId%_Subclass 6 " + subClass.getClassIndex() + "\">" + ClassListData.getInstance().getClass(subClass.getClassId()).getClientCode() + "</a><br>");
						}
