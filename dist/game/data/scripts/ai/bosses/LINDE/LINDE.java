 ...
 */
public class LINDE extends AbstractNpcAI
{
	// NPCs
	private static final int LINDE = 33350;
	// Spawns
	// Misc
	...
	private LINDE()
	{
		...
		if (GrandBossManager.getInstance().getStatus(LINDE) == DEAD)
		{
			...
			else
			{
				...
				final GrandBoss linel = (GrandBoss) addSpawn(LINDE, -213477, 244891, 2017, 0, false, 0);
