 ...
 */
public class FLY extends AbstractNpcAI
{
	// NPCs
	private static final int LINDE = 33351;
	// Spawns
	// Misc
	...
	private FLY()
	{
		...
		if (GrandBossManager.getInstance().getStatus(LINDE) == DEAD)
		{
			...
			else
			{
				...
				final GrandBoss linel = (GrandBoss) addSpawn(LINDE, 114720, -114798, -11199, 0, false, 0);
