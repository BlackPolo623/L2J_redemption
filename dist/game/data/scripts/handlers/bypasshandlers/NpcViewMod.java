...
public class NpcViewMod implements IBypassHandler
{
	...
	private static String getDropListButtons(Npc npc)
	{
		...
		if ((dropListGroups != null) || (dropListDeath != null) || (dropListSpoil != null))
		{
			...
			{
				sb.append("<td align=center><button value=\"掉落查看\" width=100 height=25 action=\"bypass NpcViewMod dropList DROP " + npc.getObjectId() + "\" back=\"L2UI_CT1.Button_DF_Calculator_Down\" fore=\"L2UI_CT1.Button_DF_Calculator\"></td>");
			}
			
			if (dropListSpoil != null)
			{
				sb.append("<td align=center><button value=\"回收查看\" width=100 height=25 action=\"bypass NpcViewMod dropList SPOIL " + npc.getObjectId() + "\" back=\"L2UI_CT1.Button_DF_Calculator_Down\" fore=\"L2UI_CT1.Button_DF_Calculator\"></td>");
			}
	...
	private void sendNpcDropList(Player player, Npc npc, DropType dropType, int pageValue)
	{
		...
		for (int i = start; i < end; i++)
		{
			...
			sb.append("</td></tr><tr><td width=48 align=right valign=top><font color=\"LEVEL\">概率:</font></td>");
			sb.append("<td width=247 align=center>");
