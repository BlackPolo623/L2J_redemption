...
public class AutoPlay implements IVoicedCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player player, String params)
	{
		...
		{
			player.sendPacket(new ExShowScreenMessage("此功能只有VIP玩家才能使用.", 5000));
			player.sendMessage("此功能只有VIP玩家才能使用.");
		...
		switch (command)
		{
			case "play":
			{
				...
				content = content.replace("%attack%", player.getAutoUseSettings().getAutoActions().contains(AUTO_ATTACK_ACTION) ? "L2UI_CH3.radiobutton2" : "L2UI_CH3.radiobutton1");
				content = content.replace("%loot%", player.getAutoPlaySettings().doPickup() ? "L2UI_CH3.radiobutton2" : "L2UI_CH3.radiobutton1");
				content = content.replace("%respect%", player.getAutoPlaySettings().isRespectfulHunting() ? "L2UI_CH3.radiobutton2" : "L2UI_CH3.radiobutton1");
				content = content.replace("%range%", !player.getAutoPlaySettings().isShortRange() ? "L2UI_CH3.radiobutton2" : "L2UI_CH3.radiobutton1");
				...
				content = content.replace("%skill_button%", Config.ENABLE_AUTO_SKILL ? "<br><table width=295><tr><td height=31><center><button action=\"bypass -h voice .playskills\" value=\"选择技能\" width=200 height=31 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></center></td></tr></table>" : "");
				content = content.replace("%item_button%", Config.ENABLE_AUTO_ITEM ? "<br><table width=295><tr><td height=31><center><button action=\"bypass -h voice .playitems\" value=\"选择物品\" width=200 height=31 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></center></td></tr></table>" : "");
				content = content.replace("%potion_button%", Config.ENABLE_AUTO_POTION ? "<br><table width=295><tr><td height=31><center><button action=\"bypass -h voice .playpotion\" value=\"选择药水\" width=200 height=31 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></center></td></tr><tr><td height=31><center><table width=150><tr><td width=120><font color=\"CDB67F\">HP百分比 (%percent%)</font></td><td><edit var=\"percentbox\" width=30 height=15></td><td><button value=\"Apply\" action=\"bypass -h voice .play percent $percentbox\" width=45 height=21 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table></center></td></tr></table>" : "");
				content = content.replace("%percent%", String.valueOf(player.getAutoPlaySettings().getAutoPotionPercent()));
				
				if (player.isAutoPlaying())
				{
					content = content.replace("%status_button%", "<table width=295><tr><td height=31><center><table width=295><tr><td height=31><center><button action=\"bypass -h voice .play stop\" value=\"停止\" width=200 height=31 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table></center></td></tr></table>");
				}
				else
				{
					content = content.replace("%status_button%", "<table width=295><tr><td height=31><center><table width=295><tr><td height=31><center><button action=\"bypass -h voice .play start\" value=\"开始\" width=200 height=31 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td></tr></table></center></td></tr></table>");
				}
			...
			case "playskills":
			{
				...
				{
					for (Skill skill : player.getSummon().getAllSkills())
					{
				...
				if (paramArray.length > 1)
				{
					...
					{
						knownSkill = player.getSummon().getKnownSkill(skillId);
						if (knownSkill != null)
						{
							break;
						}
				...
				if (skills.isEmpty())
				{
					sb.append("<center><br>没有找到该技能<br></center>");
				}
				else
				{
					...
					if (page > 1)
					{
						sb.append("<td align=left width=70><a action=\"bypass -h voice .playskills " + (page - 1) + "\"><font color=\"CDB67F\">上一页</font></a></td>");
					}
					else
					{
						sb.append("<td align=left width=70><font color=\"B09878\">上一页</font></td>");
					}
					sb.append("<td align=center width=100>第 " + page + " 页/最大 " + max + "页</td>");
					if (page < max)
					{
						sb.append("<td align=right width=70><a action=\"bypass -h voice .playskills " + (page + 1) + "\"><font color=\"CDB67F\">下一页</font></a></td>");
					}
					else
					{
						sb.append("<td align=right width=70><font color=\"B09878\">下一页</font></td>");
					}
					sb.append("</tr></table><img src=\"L2UI.SquareGray\" width=295 height=1>");
				}
			...
			case "playitems":
			{
				...
				if (items.isEmpty())
				{
					sb.append("<center><br>没有找到该物品<br></center>");
				}
				else
				{
					// Generate item table.
					...
					if (page > 1)
					{
						sb.append("<td align=left width=70><a action=\"bypass -h voice .playitems " + (page - 1) + "\"><font color=\"CDB67F\">上一页</font></a></td>");
					}
					else
					{
						sb.append("<td align=left width=70><font color=\"B09878\">上一页</font></td>");
					...
					if (page < max)
					{
						sb.append("<td align=right width=70><a action=\"bypass -h voice .playitems " + (page + 1) + "\"><font color=\"CDB67F\">下一页</font></a></td>");
					}
					else
					{
						sb.append("<td align=right width=70><font color=\"B09878\">下一页</font></td>");
			...
			case "playpotion":
			{
				...
				if (items.isEmpty())
				{
					sb.append("<center><br>没有找到该药水<br></center>");
				}
				else
				{
					// Generate item table.
					...
					if (page > 1)
					{
						sb.append("<td align=left width=70><a action=\"bypass -h voice .playpotion " + (page - 1) + "\"><font color=\"CDB67F\">上一页</font></a></td>");
					}
					else
					{
						sb.append("<td align=left width=70><font color=\"B09878\">上一页</font></td>");
					...
					if (page < max)
					{
						sb.append("<td align=right width=70><a action=\"bypass -h voice .playpotion " + (page + 1) + "\"><font color=\"CDB67F\">下一页</font></a></td>");
					}
					else
					{
						sb.append("<td align=right width=70><font color=\"B09878\">下一页</font></td>");
